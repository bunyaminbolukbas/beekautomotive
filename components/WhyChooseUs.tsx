      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-2xl p-10 sm:p-12 text-center max-w-sm border border-white/20">
              <div className="text-6xl sm:text-7xl lg:text-8xl font-bold text-gray-900 mb-6 sm:mb-8">
                9.9
              </div>
