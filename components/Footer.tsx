...
export function Footer() {
  return (
    <footer className="text-white" style={{backgroundColor: '#0A0E14'}}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
          ...
          <div>
            ...
            <ul className="space-y-1">
              ...
              <li><Link href="/aanbod" className="text-sm text-gray-400 hover:text-white transition-colors">ALLE MERKEN</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li><Link href="/financiering" className="text-sm text-gray-400 hover:text-white transition-colors">FINANCIERINGEN</Link></li>
          ...
          <div>
            ...
            <div className="space-y-1">
              ...
              <div>
                <Link href="mailto:info@beekautomotive.nl" className="text-sm text-gray-400 hover:text-white transition-colors">INFO@BEEKAUTOMOTIVE.NL</Link>
              </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 text-sm">
            <Link href="#" className="text-gray-400 hover:text-white transition-colors">Algemene voorwaarden</Link>
            <Link href="#" className="text-gray-400 hover:text-white transition-colors">Privacyverklaring</Link>
          </div>
        </div>
      </div>
    </footer>
